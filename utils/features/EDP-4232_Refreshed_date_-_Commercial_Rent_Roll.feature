...
Scenario: Verify updated date format in Commercial Rent Roll Report
  Given User logs into Power BI
  When User selects the workspace
  And User opens the Commercial Rent Roll Report
  Then 'Refresh Date:' string should present in the prefix of Refresh Date Visual
  And User should see the updated date in the format: 
