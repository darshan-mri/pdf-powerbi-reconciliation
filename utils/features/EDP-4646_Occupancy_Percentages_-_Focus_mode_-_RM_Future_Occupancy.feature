Feature: Residential Future Occupancy
  ...
  Scenario: Expanding the Occupancy Percentages Table and Navigating Back to the Report
    Given User logs into Power BI
    And User selects the workspace
    When User opens the report
    And User clicks on the Focus Mode button/icon from the Occupancy Percentages table
