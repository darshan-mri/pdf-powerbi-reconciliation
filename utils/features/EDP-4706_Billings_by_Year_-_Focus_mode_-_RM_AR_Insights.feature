Feature: Residential AR Insights
  ...
  Scenario: User interacts with Billings by Year chart in Focus Mode
    Given User logs into Power BI
    And User selects the workspace
    When User opens the report
    And User clicks on the "Total Open AR by Year" chart
    And User clicks on the Focus Mode button/icon for the "Billings by Year" chart
