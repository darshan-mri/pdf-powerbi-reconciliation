Feature: Reporting Options Filter - Financial portfolio Hub

Scenario: Validate reporting option filter of Financial portfolio Hub report
Given the user logs into Power BI
And selects the workspace
And opens Financial portfolio Hub Report
