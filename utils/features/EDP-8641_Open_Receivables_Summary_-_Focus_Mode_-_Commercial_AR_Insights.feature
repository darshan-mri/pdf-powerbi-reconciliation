Feature: Commercial AR Insights - Open Receivables Summary - Focus Mode

  Scenario: User views and interacts with Open Receivable Summary and Focus Mode
    Given the user logs into the Power BI application
    And the user selects the workspace
    When the user opens the report
    And clicks on Open Receivable Summary
