Feature: Days Vacant Details Table - focus Mode

  Scenario: User interacts with the Days Vacant Details table in Focus Mode

    Given the user logs into Power BI
    And the user selects the workspace
    When the user opens the report
    And clicks on the Days Vacant Details table
