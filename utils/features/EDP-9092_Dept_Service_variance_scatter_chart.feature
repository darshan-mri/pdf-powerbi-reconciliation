...
Scenario: User interacts with the Dept Service variance scatter chart
Given User logs into PowerBI
When User opens Financial Portfolio Hub report from the workspace
And User click on the Debt Service keycard
...
When User hovers of the Filters icon in the Debt Service variance scatter chart
