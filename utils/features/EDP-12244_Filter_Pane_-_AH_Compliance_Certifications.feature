Feature: Filter Pane - AH Compliance Certifications

  Scenario: User interacts with the Filter Pane in the AH Compliance Certifications report
    Given the user is logged into Power BI
    And has selected the appropriate Workspace
    And opened the "AH Compliance Certifications" report
