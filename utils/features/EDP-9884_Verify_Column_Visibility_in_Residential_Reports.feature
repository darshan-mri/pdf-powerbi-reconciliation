Scenario: User interacts with Residential Reports and edits columns visibility
    ...
    Then The User should be able to see the following columns in any of the tables, and all the columns should be hidden:
      | MRIClientID    |
      | CreatedDate    |
      | UpdatedDate    |
      | IsCurrentRow   |
