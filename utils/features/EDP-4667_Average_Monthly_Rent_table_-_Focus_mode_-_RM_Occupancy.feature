Feature: Residential Occupancy - Focus Mode for Average Monthly Rent Table

  Scenario: User interacts with the Average Monthly Rent table in Focus Mode
    Given User logs into Power BI
    And User selects the workspace
    When User opens the report
    And clicks on the Average Monthly Rent table
