Feature: Residential AR Pattern
  ...
  Scenario: Verifying Focus Mode functionality for the Tenant AR Patterns table
    Given User logs into Power BI
    And User selects the workspace
    When User opens the report
    And clicks on the Focus Mode button/icon from the Tenant AR Patterns table
