Feature: Average Vacancy Loss Chart -  Focus Mode

  Scenario: User interacts with the Average Vacancy Loss chart in Focus Mode

    Given the user logs into Power BI
    And the user selects the workspace
    When the user opens the report
    And navigates to the Average Vacancy Loss chart
