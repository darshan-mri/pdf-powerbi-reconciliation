Feature: Commercial AR Insights - Total Open AR by Year - Focus Mode

  Scenario: User views and interacts with Total Open AR by Year and Focus Mode
    ...
    Then the user should see the data loaded properly with their corresponding tooltip values for the following visuals:
      ...
      | Billings by Year     |
      | Credits by Year      |
    When the user clicks on the Focus Mode button/icon for the Pie Chart
