...
Scenario: User interacts with the NOI scatter chart
Given User logs into PowerBI
When User opens Financial Portfolio Hub report from the workspace
And User click on the NOI keycard
...
When User hovers of the Filters icon in the NOI variance scatter chart
