...
Scenario: 3 Confirm available options
...
Scenario: 4 Persistent disabled state
...
Scenario: 7 Verify unsaved changes warning
When I click the Users tab in the top left
Then a warning should appear notifying about unsaved data

Scenario: 8 Verify filter
...
Scenario: 10 Persistent disabled state on user
...
Scenario: 12 Verify access source
...
Scenario: 14 Verify access removal
