...
Scenario: User interacts with the Capex keycard and scatter chart
Given User logs into PowerBI
When User opens Financial Portfolio Hub report from the workspace
And User click on the Capex keycard
...
When User hovers of the Filters icon in the Capex variance scatter chart
