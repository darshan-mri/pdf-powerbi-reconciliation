Feature: Reporting Options Filter - Financial NOI Analysis

Scenario: Validate reporting option filter of Financial NOI Analysis report
Given the user logs into Power BI
And selects the workspace
And opens Financial NOI Analysis Report
