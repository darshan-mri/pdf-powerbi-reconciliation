Feature: Residential Lease Execution - Update/Refreshed Date
Scenario: Verify updated date format in Residential Lease Execution Report
  Given User logs into Power BI
  When User selects the workspace
  And User opens the Residential Lease Execution Report
