Feature: Residential AR Insights
  ...
  Scenario: User views Open Receivables by Transaction Year and interacts with the chart
    Given User logs into Power BI
    And User selects the workspace
    When User opens the report
    And User clicks on "Open Receivables by Transaction Year"
    Then The clustered column chart with proper data should be loaded
