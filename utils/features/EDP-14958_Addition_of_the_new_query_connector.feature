Feature: Query Connector
  ...
  Scenario: Add a new query connector successfully
    ...
    Then Execute button should be enabled
    And clicks on the "Save" button
    Then the query connector should be created successfully
    And a success message should be displayed
    And the newly created connector should be visible in the list