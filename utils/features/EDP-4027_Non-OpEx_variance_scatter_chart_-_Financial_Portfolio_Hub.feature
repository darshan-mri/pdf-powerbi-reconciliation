Feature: Interactions with the Non-OpEx Variance Scatter Chart and Visuals in Financial Portfolio Hub

  Scenario: User interacts with the Non-OpEx Variance Scatter Chart and updates visuals accordingly
    ...
    Then the values/visuals in the scatter chart should be updated as per the selected range
    ...
    When User hovers over the Filters icon in the Non-OpEx variance scatter chart
