Feature: Residential Lease Expiration - Focus Mode Interaction with Expiring Rent Chart

  Scenario: User interacts with the Expiring Rent chart in Focus Mode
    Given User logs into Power BI
    And User selects the workspace
    When User opens the report
    And the user navigates to the Expiring Rent chart
