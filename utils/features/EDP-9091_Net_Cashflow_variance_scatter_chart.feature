...
Scenario: User interacts with the Net Cashflow keycard and scatter chart
Given User logs into PowerBI
When User opens Financial Portfolio Hub report from the workspace
And User click on the Net Cashflow keycard
...
When User hovers of the Filters icon in the Net Cashflow variance scatter chart
