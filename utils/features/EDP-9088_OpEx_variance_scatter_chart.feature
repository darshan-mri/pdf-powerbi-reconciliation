...
Scenario: User interacts with the Opex Variance scatter chart
Given User logs into PowerBI
When User opens Financial Portfolio Hub report from the workspace
And User clicks on the Operating Expenses keycard
...
When User hovers of the Filters icon in the Operating Expenses variance scatter chart
